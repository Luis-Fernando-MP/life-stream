import { ITreeNodeData, TreeColor } from '@/shared/tree/RedBlackTree'
...
interface TreeGraphParams {
  ...
  onNodeClick: (click: MouseEvent, data: INodeResponse) => void
}
